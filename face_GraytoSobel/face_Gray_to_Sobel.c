...
int main() {
    const char* inputFile = "face.bmp";
    const char* outputFile = "face_grayscale.bmp";
    const char* edgeFile = "face_output_edge.bmp";
    const char* memFile = "face_output_image.mem";  // MEM 파일 이름 추가
    const int IMAGE_WIDTH = 630;
    const int IMAGE_HEIGHT = 630;

    FILE* inFile = NULL;
    FILE* outFile = NULL;
    FILE* edgeOutFile = NULL;
    ...
    printf("출력 파일: %s\n", memOutFile);
    printf("Verilog MEM 파일로 저장되었습니다.\n");
